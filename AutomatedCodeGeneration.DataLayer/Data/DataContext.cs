...
public sealed class DataContext : DbContext
{
    ...
    {
        _connectionString = connectionString ?? "Data Source=localhost,1433;Initial Catalog=AutomatedCodeGeneration;User Id=sa;Password=yourStrong(!)Password";
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder options)
    {
        ...
        // base.OnConfiguring does Nothing
    }
}