...
public class CSharpClassFileModel : ClassFileModel
{
    ...
    public override StringBuilder Generate()
    {
        ...
        FieldsAndProperties.ForEach(d =>
        {
            ...
            builder.Append($"{Helper.ToString(d.Access)} ");
            if (d.NameType.IsStatic)
            {
                builder.Append(d.NameType.IsStatic ? "static " : "");
            }
            builder.Append($"{d.NameType.Type} {d.NameType.Name}{NewLine}");
